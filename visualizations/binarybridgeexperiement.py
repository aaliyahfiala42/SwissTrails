# -*- coding: utf-8 -*-
"""BinaryBridgeExperiement.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_ub_juxwsfsGMX8JGbK10LT45zUGkdXO
"""
...
k = 50 #control for randomness of early choices
...
def update(frame_index):
    ...
    ax_scene.text(3.0, -5, "Bridge 2", ha="center")
    ...
    info_text = (
        ...
        f"Probability\n"
        f"P(Bridge 1): {row['p1']:.2f}\n"
        f"P(Bridge 2): {row['p2']:.2f}\n\n"
    )
